...
const ProjectDetails = () => {
    ...
    let project = data.filter(x => x.id === id)[0];
        ...
        <>
            <div className="container">
                ...
                <div className={`row flex-column-reverse flex-md-row ${styles.cBody}`}>
                    ...
                    {/* Right Section (CLEAN CARD) */}
                    <div className="col-md-6">
                        <div className={`card ${styles.card}`}>
                            <img className="card-img-top" src={project.card.img} alt="Project card" />
                        </div>
                    </div>
                </div>
            ...
            <div className="container" style={{ paddingRight: '0px' }}>
                <div className={`row mt-3 ${styles.tBody}`}>
                    <p className={styles.pTitle}>Why Companies Choose Tech Hive World</p>
                    <div>
                        <OtherProjects />
                    </div>
                </div>
